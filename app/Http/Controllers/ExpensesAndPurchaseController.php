    ...
    { 
       ...
       // dd($request);
        ...
        if($total_pay == $total_pay_form){
            ...
            $retorno = $this->discount_inventory($expense->id);
            ...
            if($validate_boolean1 == true){
                $var->save();
                    ...
                    $this->add_pay_movement($payment_type,$header_voucher->id,$var->id_account,$expense->id,$user_id,$var->amount,0);
            ...
            if($validate_boolean2 == true){
                ...
                $this->add_pay_movement($payment_type2,$header_voucher->id,$var2->id_account,$expense->id,$user_id,$var2->amount,0);
            ...
            if($validate_boolean3 == true){
                ...
                $this->add_pay_movement($payment_type3,$header_voucher->id,$var3->id_account,$expense->id,$user_id,$var3->amount,0);
            ...
            if($validate_boolean4 == true){
                ...
                $this->add_pay_movement($payment_type4,$header_voucher->id,$var4->id_account,$expense->id,$user_id,$var4->amount,0);
            
            }
            if($validate_boolean5 == true){
                $var5->save();

                $this->add_pay_movement($payment_type5,$header_voucher->id,$var5->id_account,$expense->id,$user_id,$var5->amount,0);
             
            }
            if($validate_boolean6 == true){
                $var6->save();

                $this->add_pay_movement($payment_type6,$header_voucher->id,$var6->id_account,$expense->id,$user_id,$var6->amount,0);
            
            }
            if($validate_boolean7 == true){
                $var7->save();

                $this->add_pay_movement($payment_type7,$header_voucher->id,$var7->id_account,$expense->id,$user_id,$var7->amount,0);
            ...
            if(isset($account_cuentas_por_cobrar)){
                $this->add_movement($header_voucher->id,$account_cuentas_por_cobrar->id,$expense->id,$user_id,0,$total_pay_form);
            }
            ...
            /*Aplicamos los movimientos Contables */
                ...
                if(isset($account_cuentas_por_cobrar)){
                    $this->add_movement($header_voucher->id,$account_cuentas_por_cobrar->id,$expense->id,$user_id,$total_pay_form,0);
                }
                ...
                if(isset($account_cuentas_por_cobrar)){
                    $this->add_movement($header_voucher->id,$account_subsegmento->id,$expense->id,$user_id,0,$sub_total);
                }
                ...
                if($base_imponible != 0){
                    ...
                    if(isset($account_cuentas_por_cobrar)){
                        $this->add_movement($header_voucher->id,$account_debito_iva_fiscal->id,$expense->id,$user_id,0,$total_iva);
                    }
                }
                ...
                if(isset($account_cuentas_por_cobrar)){
                    $this->add_movement($header_voucher->id,$account_mercancia_venta->id,$expense->id,$user_id,0,$sub_total);
                }
                ...
                if(isset($account_cuentas_por_cobrar)){
                    $this->add_movement($header_voucher->id,$account_costo_mercancia->id,$expense->id,$user_id,$sub_total,0);
                }
                /*----------- */
