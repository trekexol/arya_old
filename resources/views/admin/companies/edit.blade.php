...
@if ($errors->any())
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form  method="POST"   action="{{ route('companies.update',$user->id) }}" enctype="multipart/form-data" >
                @method('PATCH')
                @csrf()
                        ...
                        <div class="col-12 ">
                            ...
                            <br>
                                <div class="form-group row">
                                    ...
                                    <div class="form-group col-sm-6">
                                        <a href="{{ route('companies') }}" name="danger" type="button" class="btn btn-danger btn-block">Cancelar</a>
                                    </div>
                                </div>
