                ...
                <div class="row justify-content-center">
                  <div class="col-6">
                    <div class="list-group" id="list-tab" role="tablist">
                      ...
                      <li class="list-group-item list-group-item-action list-group-item-dark text-center" id="list-profile-list" data-bs-toggle="list"  role="tab" aria-controls="profile">Activo 144.500.000,00</li>
                      ...
                      <li class="list-group-item list-group-item-action list-group-item-dark text-center" id="list-settings-list" data-bs-toggle="list" role="tab" aria-controls="settings">Capital 133.100.000,00</li>
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="list-group" id="list-tab" role="tablist">
                      ...
                      <li class="list-group-item list-group-item-action list-group-item-dark text-center" id="list-profile-list" data-bs-toggle="list"  role="tab" aria-controls="profile">Ingresos 49.225.211,00</li>
                      ...
                      <li class="list-group-item list-group-item-action list-group-item-dark text-center" id="list-settings-list" data-bs-toggle="list" role="tab" aria-controls="settings">Gastos 3.309.615,40</li>
                ...
                <div class="row justify-content-center">
                  <div class="col-6">
                    <div class="list-group" id="list-tab" role="tablist">
                      ...
                      <li class="list-group-item list-group-item-action list-group-item-dark text-center" id="list-profile-list" data-bs-toggle="list"  role="tab" aria-controls="profile">Cuentas por Cobrar -500,00</li>
                      ...
                      <li class="list-group-item list-group-item-action list-group-item-dark text-center" id="list-settings-list" data-bs-toggle="list" role="tab" aria-controls="settings">Préstamos Bancarios 0,00</li>
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="list-group" id="list-tab" role="tablist">
                      ...
                      <li class="list-group-item list-group-item-action list-group-item-dark text-center" id="list-profile-list" data-bs-toggle="list"  role="tab" aria-controls="profile">Banesco -41.420.670,00</li>
                      ...
                      <li class="list-group-item list-group-item-action list-group-item-dark text-center" id="list-settings-list" data-bs-toggle="list" role="tab" aria-controls="settings">Mercantil 8.010.810,40</li>
