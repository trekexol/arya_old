    ...
    <div class="row justify-content-center" >
            ...
            <div class="card" style="width: 70rem;" >
                ...
                <div class="card-body" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="total_factura" type="text" class="form-control @error('total_factura') is-invalid @enderror" name="total_factura" value="{{ number_format($quotation->total_factura / ($rate ?? 1), 2, ',', '.') ?? 0 }}" readonly required autocomplete="total_factura">
                            ...
                            <div class="col-md-3">
                                <input id="base_imponible" type="text" class="form-control @error('base_imponible') is-invalid @enderror" name="base_imponible" value="{{ number_format($quotation->base_imponible / ($rate ?? 1), 2, ',', '.') ?? 0 }}" readonly required autocomplete="base_imponible">
            ...
            <form method="POST" action="{{ route('quotations.storefactura') }}" enctype="multipart/form-data">
                @csrf   
                        ...
                        <!--Total del pago que se va a realizar-->
                        <input type="hidden" id="sub_total_form" name="sub_total_form" value="{{ $quotation->total_factura / ($rate ?? 1) }}" readonly>
...
@section('consulta')
    ...
    <script type="text/javascript">
            ...
            function calculate() {
                ...
                let totalFactura = "<?php echo $quotation->total_factura / ($rate ?? 1)?>";       

                //AQUI VAMOS A SACAR EL MONTO DEL IVA DE LOS QUE ESTAN EXENTOS, PARA LUEGO RESTARSELO AL IVA TOTAL
                let totalBaseImponible = "<?php echo $quotation->base_imponible / ($rate ?? 1)?>";

                let totalIvaMenos = (inputIva * "<?php echo $quotation->base_imponible / ($rate ?? 1); ?>") / 100;  
