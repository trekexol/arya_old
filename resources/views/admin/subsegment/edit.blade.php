...
@if ($errors->any())
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header">Editar Sub Segmento</div>
    
                    <div class="card-body">
            <form  method="POST"   action="{{ route('subsegment.update',$var->id) }}" enctype="multipart/form-data" >
                @method('PATCH')
                @csrf()
                            ...
                            <form>
                                ...
                                <div class="form-group row">
                                    <label for="segmento" class="col-md-4 col-form-label text-md-right">Segmento
                                        @error('segments')
                                    ...
                                    <select class="form-control" id="segment_id" name="segment_id">
                                        <option value="{{ $var->segment_id }}" {{ old('Segments') }}>{{ $var->segments['description'] }}</option>
