       ...
       @include('layouts.home_navbar')
        ...
        <header class="masthead">
            <div class="container">
                ...
                <div class="masthead-heading text-uppercase">Maneja las finanzas de tu empresa</div>
                <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="#about">Saber mas ...</a>
            </div>
        </header>
